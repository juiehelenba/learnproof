    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                ...
                @else
                    <a href="{{ route('login') }}" class="text-sm text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-100">Entrar</a>
                    @if (Route::has('register'))
                        <a href="{{ route('register') }}" class="ms-4 text-sm text-indigo-600 dark:text-indigo-400 hover:underline">Registrar</a>
                    @endif
                @endauth
            </div>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        ...
        @else
            <div class="pt-4 pb-1 border-t border-gray-200 dark:border-gray-600 px-4 space-y-1">
                ...
                @if (Route::has('register'))
                    <x-responsive-nav-link :href="route('register')">Registrar</x-responsive-nav-link>
                @endif
            </div>
        @endauth
    </div>
